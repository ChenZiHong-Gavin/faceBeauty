...
from smoothAndWhitening import getSkin


class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(527, 811)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.cameraShow = QtWidgets.QLabel(self.centralwidget)
        self.cameraShow.setGeometry(QtCore.QRect(10, 20, 501, 771))
        self.cameraShow.setObjectName("cameraShow")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(30, 640, 461, 141))
...
"border-style: outset;")
        ...
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(0, 60, 191, 31))
        ...
        self.horizontalSlider_3 = QtWidgets.QSlider(self.horizontalLayoutWidget_4)
        self.horizontalSlider_3.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_3.setObjectName("horizontalSlider_3")
        self.horizontalLayout_3.addWidget(self.horizontalSlider_3)
        self.horizontalLayoutWidget_5 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_5.setGeometry(QtCore.QRect(0, 90, 191, 31))
        ...
        self.horizontalSlider_4 = QtWidgets.QSlider(self.horizontalLayoutWidget_5)
        self.horizontalSlider_4.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_4.setObjectName("horizontalSlider_4")
        self.horizontalLayout_5.addWidget(self.horizontalSlider_4)
        self.horizontalLayoutWidget_6 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_6.setGeometry(QtCore.QRect(0, 120, 191, 31))
        ...
        self.horizontalSlider_5 = QtWidgets.QSlider(self.horizontalLayoutWidget_6)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "美白"))
        self.label_2.setText(_translate("MainWindow", "磨皮"))
        self.label_3.setText(_translate("MainWindow", "大眼"))
        self.label_4.setText(_translate("MainWindow", "瘦脸"))
        self.label_5.setText(_translate("MainWindow", "红唇"))
    # label上实时显示图像函数
    ...
    def show_viedo(self):
        ...
        if ret:
            self.img = getSkin.cr_otsu(self.img)
